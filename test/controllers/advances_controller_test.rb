...
class AdvancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advance" do
    assert_difference('Advance.count') do
      post advances_url, params: { advance: { account_id: @advance.account_id, amount: @advance.amount } }
    end
  ...
  test "should update advance" do
    patch advance_url(@advance), params: { advance: { account_id: @advance.account_id, amount: @advance.amount } }
